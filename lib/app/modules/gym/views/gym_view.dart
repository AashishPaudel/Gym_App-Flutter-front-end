        ...
        child: Obx(() => !controller.refreshValue.value
            ? Column(
                children: [
                  ...
                  Expanded(
                    child: controller.gymList != null &&
                            controller.gymList.isNotEmpty
                        ? ListView.builder(
                            shrinkWrap: true,
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  controller.setSelectedGym(
                                      controller.gymList[index]);
                                  Get.toNamed(GymDetails.id,
...
class GymWidget extends StatelessWidget {
  const GymWidget(
      {Key key, @required this.name, @required this.description, this.time})
      : super(key: key);
